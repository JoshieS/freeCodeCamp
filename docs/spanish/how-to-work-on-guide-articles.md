# Cómo Trabajar en Artículos Guía

Con tu ayuda, Nosotros podemos crear una herramienta comprensiva de referencia que ayudara a millones de personas que estan aprendiendo a programar en los años por venir. 💛 

Tu puedes:

- [Ayudanos creando y editando articulos guía](#steps-for-creating-and-editing-guide-articles).
- [Ayudanos revisando Pull Requets de articulos guia]()

## Pasos para Crear y Editar Articulos Guia
    

1. 🍴 [Fork Este repositorio](https://github.com/freeCodeCamp/freeCodeCamp#fork-destination-box)
2. 👀️ Sigue las pautas para contribuir descritas abajo.
3. 🔧 Realiza unos asombrosos cambios!
4. 📖 Lee estas [pautas de estilos para mejores practicas](/docs/style-guide-for-guide-articles).
5. 👉 [Realiza un pull request](https://github.com/freeCodeCamp/freeCodeCamp/compare)
6. 🎉 Obten tu pull request aprovado - Exito!
      

O solo [crea un issue](https://github.com/freeCodeCamp/freeCodeCamp/issues) - cualquier ayuda incluso pequeña cuenta! 😊
### [Sigue estas pautas recomendadas en nuestra guía de estilo para un artículo de guía convincente](/docs/style-guide-for-guide-articles.md)

### Creando un pull request (PR) para proponer cambios

Existen dos maneras que puedes proponer un cambio a un repositorio, luego de editar o agregar un articulo guia: 
- [usando la interfaz en linea de github en tu navegador](#using-the-github-web-interface-on-your-browser).
- [Trabajando desde tu computador personal](#working-on-your-local-machine) (_Recomendado_ para ver cambios).
    
#### Usando la interfaz web de github en tu navegador
 
Mira la demostracion en video o sigue los siguientes pasos debajo de el:
**[TODO]** Actualiza la grabacion de gif.
 
![Gif mostrando los pasos a seguir en la interfaz de github](#)
    
1. Ve a la carpeta **"pages"** (localizados en [`client/src/pages/guide`](/client/src/pages/guide)) y encuentra el articulo anexado que te gustaria escribir o editar.
   
    > Todod lo anexado ira en el documento index.md
